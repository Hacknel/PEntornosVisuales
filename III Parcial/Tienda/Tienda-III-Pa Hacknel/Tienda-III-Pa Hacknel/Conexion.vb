...
Public Class conexion
    Public conexion As SqlConnection = New SqlConnection("Data Source=HACKNEL;Initial Catalog=TiendaIIIP;Integrated Security=True")
    ...
    Public Function insertarUsuario(idUsuario As Integer, nombre As String, apellido As String, userName As String,
        ...
        Try
            ...
            cmb.Parameters.AddWithValue("@psw", Encriptar(psw))
    ...
    Public Function modificar(ByVal idUsuario As Integer, ByVal nombre As String, ByVal apellido As String, ByVal userName As String, ByVal psw As String, ByVal rol As String, ByVal correo As String) As Boolean
        Try
            conexion.Open()
